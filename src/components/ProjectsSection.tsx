...
export function ProjectsSection() {
  ...
  const projects = [
    ...
    },
    {
      ...
      images: [
        { src: "ProdPics/Esk8-1.png", caption: "Placeholder caption." },
        { src: "ProdPics/Esk8-2.png", caption: "Placeholder caption." },
        { src: "ProdPics/Esk8-3.png", caption: "Placeholder caption." },
        { src: "ProdPics/Esk8-4.png", caption: "Placeholder caption." },
        { src: "ProdPics/Esk8-5.png", caption: "Placeholder caption." },
        { src: "ProdPics/Esk8-6.png", caption: "Placeholder caption." },
        { src: "ProdPics/Esk8-7.png", caption: "Placeholder caption." },
        { src: "ProdPics/Esk8-8.png", caption: "Placeholder caption." },
        { src: "ProdPics/Esk8-9.png", caption: "Placeholder caption." },
        { src: "ProdPics/Esk8-10.png", caption: "Placeholder caption." },
