  ...
  const projects = [
    ...
    },
    {
      ...
      images: [
        ...
        { src: "ProdPics/Esk8-CAD-1-Riser+Headlight-Fixture-Exploded View.jpg", caption: "Exploded view — riser and dual-headlight assembly showing fastener placement, component integration, and assembly sequence" },
        { src: "ProdPics/Esk8-CAD-2-Riser+Headlight-Fixture.jpeg", caption: "Riser and headlight fixture — increased ground clearance, validated beam-angle geometry, and modular LED mounting for serviceability" },
        { src: "ProdPics/Esk8-CAD-3-CREE Dual-LED headlight-holder.jpeg", caption: "Dual-LED headlight mount — elastic press-fit retention for LED bulbs, parallel wiring, and ESC-controlled remote on/off" },
        { src: "ProdPics/Esk8-CAD-4-Riser+Taillight-Fixture.jpeg", caption: "Riser and taillight fixture — increased ground clearance with built-in taillight housing for improved visibility" },
        ...
        { src: "ProdPics/Esk8-CAD-9-GT2B-Trigger-Guard.jpeg", caption: "Placeholder caption." },
      ],
    },
    {
      id: 3,
