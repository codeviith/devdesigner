  ...
  const projects = [
    ...
    },
    {
      ...
      images: [
        ...
        { src: "ProdPics/CoreXY-2.png", caption: "Front system view — excellent printer geometry, LCD interface, and rigid frame alignment designed to maintain dimensional accuracy and print consistency" },
        ...
        { src: "ProdPics/CoreXY-6.jpg", caption: "Extrusion system detail — dual-geared extruder for stable filament feeding and proper wire management for smooth X-gantry travel" },
        ...
        { src: "ProdPics/CoreXY-11.png", caption: "Integrated lighting system — high-output LED array providing clear part visibility for inspection and quality control during or after printing" },
        { src: "ProdPics/CoreXY-12.png", caption: "Belt tension adjustment — precision knob used to fine-tune CoreXY belt tension load for accurate motion control" },
        ...
        { src: "ProdPics/CoreXY-16.png", caption: "Vibration dampening system — printer supported on squash ball dampers to reduce acoustic noise and mechanical resonance" },
