  ...
  const projects = [
    ...
    },
    {
      ...
      images: [
        ...
        { src: "ProdPics/CoreXY-6.jpg", caption: "Extrusion system detail — dual-geared extruder supporting stable filament feeding with organized wire routing for smooth X-gantry travel" },
